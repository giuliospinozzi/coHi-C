...
do
  ...
  echo ${arr[2]}/${arr[0]} #3° colonna: path project directory + sample name (indici partono da 0)
  cd ${arr[2]}/${arr[0]}
  ...
  hicConvertFormat -m ${RESOLUTION}_resolution/${arr[3]}_${RESOLUTION}.cool --inputFormat cool --outputFormat mcool -o ${RESOLUTION}_resolution/${arr[3]}.mcool --resolutions ${RESOLUTION}

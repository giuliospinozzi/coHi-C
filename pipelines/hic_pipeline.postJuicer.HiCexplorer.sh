...
for k in $(ls -d $WORKING_DIR/*); do
    printf "\n###############################################"
    printf "Processins Sample --> ${k#"$WORKING_DIR/"}"
    printf "\n############################################### \n"
    ...
    hicConvertFormat -m inter_30.hic --inputFormat hic --outputFormat cool -o inter_30_chr2.cool --resolutions 10000 --chromosome 2
    hicConvertFormat -m inter_30.hic --inputFormat hic --outputFormat cool -o inter_30_chr11.cool --resolutions 10000 --chromosome 11
    ...
    printf "\n>>>>>>>>>> ${SAMPLE} --> hicPCA \n"
    hicPCA --matrix inter_30_10000.corrected.h5 -o pca1.bedgraph pca2.bedgraph --chromosomes 2 11 -f bedgraph

    printf "\n>>>>>>>>>> ${SAMPLE} --> hicPlotMatrix \n"
    # Edit for specific project
    hicPlotMatrix -m inter_30_10000.corrected.h5 --clearMaskedBins --region chr2:60221755-61279177 -o ${SAMPLE}_10000_log2_chr2_60221755-61279177_matrix_plot.png
    hicPlotMatrix -m inter_30_10000.corrected.h5 --clearMaskedBins --region chr11:4769502-5825416 -o ${SAMPLE}_10000_log2_chr11_4769502-5825416_matrix_plot.png

    printf "\n>>>>>>>>>> ${SAMPLE} --> hicFindTADs \n"
    hicFindTADs -m inter_30_10000.corrected.h5 --outPrefix tads_hic_corrected --numberOfProcessors $MAXTHREADS --chromosomes 2 11 --correctForMultipleTesting fdr --maxDepth 100000 --thresholdComparisons 0.05 --delta 0.01
done
...
#hicDifferentialTAD -tm UT1.100000_chr2.cool -cm E22.100000_chr2.cool -td UT1_domains.bed -o differential -p 0.01 -t 4 -mr all
#hicDifferentialTAD -tm UT1.100000_chr11.cool -cm E22.100000_chr11.cool -td UT1_domains.bed -o differential -p 0.01 -t 4 -mr all

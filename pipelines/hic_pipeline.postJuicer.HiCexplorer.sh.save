...
for k in $(ls -d $WORKING_DIR/*/); do
    ...
    hicPCA -m ${RESOLUTION}_resolution/inter_30_5000.corrected.h5 --outputFileName ${RESOLUTION}_resolution/pca1.bw ${RESOLUTION}_resolution/pca2.bw --format bigwig

    printf "\n>>>>>>>>>> ${SAMPLE} --> hicTransform \n"
    hicTransform -m ${RESOLUTION}_resolution/inter_30_5000.corrected.h5 --outFileName ${RESOLUTION}_resolution/obs_exp.h5 --method obs_exp --perChromosome

    printf "\n>>>>>>>>>> ${SAMPLE} --> hicPlotMatrix: A/B compartments can be plotted \n"
    #echo -e  "2\t60221755\t61279177" >> ${RESOLUTION}_resolution/regions.bed
    #echo -e  "11\t4769502\t5825416" >> ${RESOLUTION}_resolution/regions.bed
    hicPlotMatrix -m ${RESOLUTION}_resolution/obs_exp.h5 --outFileName ${RESOLUTION}_resolution/A-B.compartments.pca1.png --perChromosome --bigwig ${RESOLUTION}_resolution/pca1.bw --dpi 300
    #hicAdjustMatrix --matrix ${RESOLUTION}_resolution/obs_exp.h5 --outFileName ${RESOLUTION}_resolution/obs_exp_regions.h5 --action keep --regions ${RESOLUTION}_resolution/regions.bed
    #hicPlotMatrix -m ${RESOLUTION}_resolution/obs_exp_regions.h5 --outFileName ${RESOLUTION}_resolution/A-B.compartments.pca1.png --perChromosome --bigwig ${RESOLUTION}_resolution/pca1.bw --dpi 300 
    ...
    printf "\n>>>>>>>>>> ${SAMPLE} --> hicFindTADs \n"
    hicFindTADs -m ${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 --outPrefix ${RESOLUTION}_resolution/tads_hic_corrected --numberOfProcessors $MAXTHREADS --correctForMultipleTesting fdr --maxDepth $((${RESOLUTION}*10)) --thresholdComparisons 0.05 --delta 0.01
...
hicDifferentialTAD -cm UT1/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -tm E22/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -td E22/${RESOLUTION}_resolution/tads_hic_corrected_domains.bed -o analysis/${RESOLUTION}_resolution/differential_tads_UT1-E22 -p 0.01 -t 4 -mr all
hicDifferentialTAD -cm UT1/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -tm E23/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -td E23/${RESOLUTION}_resolution/tads_hic_corrected_domains.bed -o analysis/${RESOLUTION}_resolution/differential_tads_UT1-E23 -p 0.01 -t 4 -mr all
hicDifferentialTAD -cm UT1/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -tm P10/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -td P10/${RESOLUTION}_resolution/tads_hic_corrected_domains.bed -o analysis/${RESOLUTION}_resolution/differential_tads_UT1-P10 -p 0.01 -t 4 -mr all
hicDifferentialTAD -cm UT1/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -tm P11/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -td P11/${RESOLUTION}_resolution/tads_hic_corrected_domains.bed -o analysis/${RESOLUTION}_resolution/differential_tads_UT1-P11 -p 0.01 -t 4 -mr all

hicDifferentialTAD -cm UT2/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -tm E22/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -td E22/${RESOLUTION}_resolution/tads_hic_corrected_domains.bed -o analysis/${RESOLUTION}_resolution/differential_tads_UT2-E22 -p 0.01 -t 4 -mr all
hicDifferentialTAD -cm UT2/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -tm E23/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -td E23/${RESOLUTION}_resolution/tads_hic_corrected_domains.bed -o analysis/${RESOLUTION}_resolution/differential_tads_UT2-E23 -p 0.01 -t 4 -mr all
hicDifferentialTAD -cm UT2/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -tm P10/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -td P10/${RESOLUTION}_resolution/tads_hic_corrected_domains.bed -o analysis/${RESOLUTION}_resolution/differential_tads_UT2-P10 -p 0.01 -t 4 -mr all
hicDifferentialTAD -cm UT2/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -tm P11/${RESOLUTION}_resolution/inter_30_${RESOLUTION}.corrected.h5 -td P11/${RESOLUTION}_resolution/tads_hic_corrected_domains.bed -o analysis/${RESOLUTION}_resolution/differential_tads_UT2-P11 -p 0.01 -t 4 -mr all
